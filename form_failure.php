...
<body>
    ...
    <div class="container">
        <h2><i class="fa-solid fa-circle-xmark fa-lg" style="color: #ab0303;"></i></h2>
        <h2>Form not be submited..!</h2>
        <h3>One or both the Aadhar number is already exist. Please provide different one.</h3>
    </div>
    <?php
